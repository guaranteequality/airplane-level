...
<div class="breadcrumbs-bar breadcrumbs-bar--top ">
    ...
    <ol class="nav-breadcrumbs">
        ...
        <li class="crumb" itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="" data-forum-id="3">
            <a href="/reply/{{$forum->id}}" itemprop="url" title="Civil Aviation">
                <span itemprop="title">{{$forum->title}}</span><span class="icon fa fa-angle-double-right"></span></a>
        </li>
    </ol>
</div>
<h2 class="posting-title"><a href="/forums/{{$forum->id}}">{{$forum->title}}</a></h2>      
     <form  class="form newtopic" action="/replysave" method="post" enctype="multipart/form-data">
             {{ csrf_field() }} 
        ...
        <fieldset class="st-editor">
            <dl style="clear: left;">
                <dd>
                  <input type="hidden" name="forumid" value="{{$forum->id}}">
                    <input type="text" placeholder="Enter Title" id="replytitle" name="replytitle" class="form-control" size="45" maxlength="120">
                </dd>
            </dl>
            <div class="st-editor__box">
                ...
                <div id="message-box">
                    ...
                    <textarea name="replycontent" id="replycontent" rows="25" cols="76" tabindex="4" class="inputbox"></textarea>
                </div>
            </div>
        </fieldset>
    </div>
