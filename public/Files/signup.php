					...
					<div class="col-md-5 order-md-1 signin-left-column bg-white px-5">
						...
						<form>
							<div class="form-group">
								...
								<input type="text" class="form-control" id="myInputname" aria-describedby="Name" placeholder="Enter Name">
							</div>
							<div class="form-group">
								<label for="exampleInputUsername">User Id</label>
								<input type="text" class="form-control" id="myInputid" aria-describedby="Id" placeholder="Enter Id">
							</div>
							<div class="form-group">
								<label for="exampleInputEmail1">Email address</label>
								<input type="email" class="form-control" id="myInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
								<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">Password</label>
								<input type="password" class="form-control" id="myInputPassword1" placeholder="Password">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword2">Confirm Password</label>
								<input type="password" class="form-control" id="myInputPassword2" placeholder="Password">
							</div>
							<div class="custom-control custom-checkbox mb-3">
								<input type="checkbox" class="custom-control-input" id="newsletter-signup">
								<label class="custom-control-label" for="newsletter-signup">I want to receive weekly Newsletters</label>
							</div>
							<button id="signregister" class="btn btn-primary btn-gradient btn-block">
								<i class="batch-icon batch-icon-quill"></i>
								Sign Up
							</button>
							<hr>
							<p class="text-center">
								Already Have An Account? <a href="sisu-signin.html">Sign In here</a>
							</p>
						</form>
					</div>
				</div>
