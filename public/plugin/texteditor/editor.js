!function($) {
    ...
    WMWysiwygEditor.prototype = {
        ...
        init: function(e) {
            ...
            this.$element.find('[data-tooltip="active"]').tooltip({
                placement: "bottom",
                container: "body",
                trigger: "hover",
                animation: !1
        ...
        createBtn: function(e) {
            ...
            return "function"in e ? i.attr("data-function", e["function"]) : "extend"in e ? i.attr("data-extend", e.extend) : "command"in e && (i.attr("data-command", e.command),
            "forcecss"in e && i.attr("data-forcecss", e.forcecss)),
        ...
        createDropdown: function(e) {
            var t = this
              ...
              , d = e.defs;
            "" == n && (n = 3 == o ? "btn-default" : "btn-secondary"),
            "sm" == a ? a = "btn-group-sm" : "xs" == a ? a = "btn-group-xs" : "lg" == a && (a = "btn-group-lg");
            var l = $("<div/>", {
                "class": "btn-group"
            });
            l.addClass(a);
            ...
            if (3 == o && c.append(' <span class="caret"></span>'),
            c.addClass(n),
            3 == o)
                var r = $("<ul/>");
            else
                var r = $("<div/>");
            return r.addClass("dropdown-menu dropdown-menu-right"),
            $.each(i, function(e, a) {
                var n = d[a]
                  , i = $("<a/>", {
                    href: "#",
                ...
                if (3 != o && i.addClass("dropdown-item"),
                "function"in n ? i.attr("data-function", n["function"]) : "extend"in n ? i.attr("data-extend", n.extend) : "command"in n && (i.attr("data-command", n.command),
                "forcecss"in n && i.attr("data-forcecss", n.forcecss)),
        ...
        createColorPicker: function(e) {
            ...
            "" == o && (o = 3 == i ? "btn-default" : "btn-secondary"),
            "sm" == n ? n = "btn-group-sm" : "xs" == n ? n = "btn-group-xs" : "lg" == n && (n = "btn-group-lg");
            var d = $("<div/>", {
                "class": "btn-group"
            });
            d.addClass(n);
            ...
            if ("3" == i && l.append(' <span class="caret"></span>'),
            l.addClass(o),
            3 == i)
                var c = $("<ul/>");
            else
                var c = $("<div/>");
            return c.addClass("dropdown-menu dropdown-menu-right wmwysiwyg-dropdown-colorpicker"),
            $.each(a, function(a, n) {
                var o = $("<button/>", {
                ...
                "function"in e ? o.attr("data-function", e["function"]) : "extend"in e ? o.attr("data-extend", e.extend) : "command"in e && (o.attr("data-command", e.command),
                "forcecss"in e && o.attr("data-forcecss", e.forcecss)),
        ...
        command: function(btn) {
            ...
            if ($clicked_btn.data("command")) {
                ...
                if (1 == css && document.execCommand("styleWithCSS", null, !0),
                "formatBlock" == cmd || "foreColor" == cmd || "backColor" == cmd) {
                    ...
                    if ($(element).hasClass("wmwysiwyg-editor") || $(element).parent().hasClass("wmwysiwyg-editor"))
                        return;
                    var element = document.getSelection().focusNode.parentNode;
                    if ($(element).is("li"))
                        return void document.execCommand(cmd, !1, null);
                    var current_padding = $(element).css("padding-left")
                      , new_padding = 0;
                    "indent" == cmd ? new_padding = parseInt(current_padding) + 30 : (new_padding = parseInt(current_padding) - 30,
                    1 > new_padding && (new_padding = "")),
                    $(element).css("padding-left", new_padding)
        ...
        createModal: function(e, t, a, n) {
            ...
            3 == i ? (f.find("span").addClass("close"),
            s.append(f),
            r.append(s)) : r.append(s).append(f);
            var m = $("<div/>", {
                "class": "modal-body"
            });
            $.each(t, function(e, t) {
            ...
            3 == i ? b.addClass("btn-default") : b.addClass("btn-secondary"),
            p.append(b).append(u),
            c.append(r).append(m).append(p),
            l.append(c),
            d.append(l),
            $("body").append(d),
            d.modal("show");
        ...
        createModalId: function(e) {
            return e = e.replace(/[^a-zA-Z0-9\s]/g, ""),
            e = e.toLowerCase(),
            e = e.replace(/\s/g, "-"),
            e = e + "-" + (Math.floor(9e4 * Math.random()) + 1e4)
        },
        ...
        pasteHtmlAtCaret: function(e) {
            ...
            if (window.getSelection) {
                ...
                t.getRangeAt && t.rangeCount) {
                    ...
                    n.innerHTML = e;
                    for (var o, i, d = document.createDocumentFragment(); o = n.firstChild; )
                        i = d.appendChild(o);
                    a.insertNode(d),
                    i && (a = a.cloneRange(),
                    a.setStartAfter(i),
        ...
        createPlaceholder: function() {
            ...
            "" == e && this.$editor.focus(),
            this.$editor.find("#wmwysiwyg-placeholder").length > 0 && this.$editor.find("#wmwysiwyg-placeholder").remove(),
            this.pasteHtmlAtCaret('<span id="wmwysiwyg-placeholder">' + e + "</span>")
        },
        ...
        fullScreen: function(e) {
            var t = this;
            $("body").toggleClass("wmwysiwyg-fullscreen-body"),
            t.$element.toggleClass("wmwysiwyg-fullscreen"),
            e.find("i").toggleClass("fa-window-restore fa-window-maximize");
    ...
    $.fn.wmwysiwyg = function() {
        var e, t = arguments[0], a = Array.prototype.slice.call(arguments, 1);
        return this.each(function() {
            var n = $(this)
              , o = n.data("wmwysiwyg")
              , i = $.extend({}, $.fn.wmwysiwyg.defaults, n.data(), "object" == typeof t && t);
            o || n.data("wmwysiwyg", o = new WMWysiwygEditor(this,i)),
            "string" == typeof t ? e = o[t].apply(o, a) : o.init()
        }),
        e
    }
    ,
    $.fn.wmwysiwyg.defaults = {
        ...
        toolbar_btn_class: "",
        height: "",
        btns: [["source", "fullScreen"], ["formatting", "fontSize"], ["bold", "italic", "underline", "strikeThrough"], ["foreColor", "backColor"], ["link", "insertImage", "createTable"], "textAlignment", ["subscript", "superscript"], ["indent", "outdent"], ["ul", "ol", "hr"], "removeFormat"],
